...
@interface INPopoverWindow () <CAAnimationDelegate>
...
{
    if ((self = [super initWithContentRect:contentRect styleMask:NSWindowStyleMaskNonactivatingPanel backing:bufferingType defer:deferCreation])) {
        [self setOpaque:NO];
